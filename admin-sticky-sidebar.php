...
function admin_sticky_sidebar_css($hook)
{
  ...
  wp_enqueue_style('admin-sticky-sidebar-style',  plugins_url('admin-sticky-sidebar.css?v=1.6.4', __FILE__));
}
...
{
  // only add to the post.php admin page.
  wp_enqueue_script('admin-sticky-sidebar-script', plugins_url('admin-sticky-sidebar.js?v=1.6.4', __FILE__));
}
